...
const LANGS = {
  en: {
    ...
    quickIntro: 'Get listed on [ofox.ai/awesome-ofox](https://ofox.ai/awesome-ofox) — real backlinks from a high-traffic AI site, plus a **$10 dev reward** when approved.',
    quickSteps: [
  ...
  zh: {
    ...
    quickH: '🚀 三步添加你的应用',
    quickIntro: '上墙 [ofox.ai/awesome-ofox](https://ofox.ai/awesome-ofox) —— 获得来自高流量 AI 网站的真实反链，审核通过还有 **$10 开发激励金**。',
    quickSteps: [
