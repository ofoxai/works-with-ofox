...
**🎁 你能得到什么：**
- **$10 开发激励金** —— 审核通过、应用上墙后，通过邮件确认发放到你的 Ofox 账户
- **应用展示** —— 上 Ofox 开发墙
...
> **领取 $10 + Partner（邮件确认发放）**：① 提交 PR → ② 通过审核、应用上墙 → ③ 发邮件到 **hi@ofox.ai**，注明：Ofox 注册邮箱、团队 ID（有多个团队时）、通过审核的应用名称 → ④ 核实后把 $10 打入该 Ofox 账户 → ⑤ 同时为你绑定 [Partner](https://ofox.ai/zh/partner) 资格。
